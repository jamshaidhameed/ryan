    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="{{ Route::currentRouteName() == 'tenant.dashboard' ? 'active' : ''}}">{{ __('titles.my_profile') }}</li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <form action="{{ route('tenant.update.profile') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col col-md-8" style="margin-top: 29px;">
                                ...
                                <input type="file" name="file" id="" class="form-control" placeholder="{{ __('titles.update_profile_pic') }}" accept="image/*">
                            </div>
